...
//opdracht 2
console.log("Energielevel van de eerste kat:", catBreeds[0].energy_level);

//opdracht 3
console.log("Het eerste temperament van de temperamenten van de tweede kat:", catBreeds[1].temperament[0]);

//opdracht 4
console.log("Het laatste temperament van de temperamenten van de derde kat:", catBreeds[2].temperament[catBreeds[2].temperament.length - 1]);
